...
///////////////////////////////////////////////////////////////////////////////////////
    ...
    _handleCommandAddWorkflowJob(aReturn)
    {
        ...
        this.rodanChannel.command(VISRC_Events.COMMAND__WORKFLOWBUILDER_GUI_ADD_ITEM_WORKFLOWJOB, {workflowjob: workflowJob});
    }
    ...
    _createInputPort(aInputPortType, aWorkflowJob)
    {
        ...
        this.rodanChannel.command(VISRC_Events.COMMAND__WORKFLOWBUILDER_GUI_ADD_ITEM_INPUTPORT, {workflowjob: aWorkflowJob, inputport: port});
    }
    ...
    _createOutputPort(aOutputPortType, aWorkflowJob)
    {
        ...
        this.rodanChannel.command(VISRC_Events.COMMAND__WORKFLOWBUILDER_GUI_ADD_ITEM_OUTPUTPORT, {workflowjob: aWorkflowJob, outputport: port});
    }
    ...
    {
        this.rodanChannel.command(VISRC_Events.COMMAND__WORKFLOWBUILDER_GUI_DELETE_ITEM_INPUTPORT, {workflowjob: aWorkflowJob, inputport: aPort});
        try
        {
            aPort.destroy();
        }
    ...
    {
        this.rodanChannel.command(VISRC_Events.COMMAND__WORKFLOWBUILDER_GUI_DELETE_ITEM_OUTPUTPORT, {workflowjob: aWorkflowJob, outputport: aPort});
        try
        {
            aPort.destroy();
        }
    ...
    _createConnection(aOutputPort, aInputPort)
    {
        ...
        this.rodanChannel.command(VISRC_Events.COMMAND__WORKFLOWBUILDER_GUI_ADD_ITEM_CONNECTION, {connection: connection, inputport: aInputPort, outputport: aOutputPort});
    }
    ...
    _createResourceAssignment(aResource, aInputPort)
    {
        ...
        // todo
        this.rodanChannel.command(VISRC_Events.COMMAND__WORKFLOWBUILDER_GUI_ADD_ITEM_RESOURCEASSIGNMENT, {resourceassignment: resourceAssignment, resource: aResource, inputport: aInputPort});
    }
}
