  ...
  module.exports = function createXMLHttpRequest(window) {
    ...
    class XMLHttpRequest extends XMLHttpRequestEventTarget {
          ...
          case "json":
            {
              ...
              const jsonStr = decodeString(properties.responseBuffer, {
                contentType,
      ...
      get responseText() {
        ...
        const contentType = getContentType(this);
        const res = decodeString(responseBuffer, {
          contentType,
          defaultEncoding: flag.encoding
        }).data;
      ...
      setRequestHeader(header, value) {
        ...
        if (lcHeader === "content-type") {
          ...
          if (contentType) {
            contentType.parameterList.filter((v) => v.key && v.key.toLowerCase() === "charset" && normalizeEncoding(v.value) !== "UTF-8").forEach((v) => {
              v.value = "UTF-8";
            });
