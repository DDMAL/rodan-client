...
const encodings = require('./encodings.json!systemjs-json');
...
function prescanMetaCharset(buffer) {
  ...
  for (let i = 0; i < l; i++) {
    ...
    if (c === 0x3C) {
      ...
      } else if ((c1 === 0x4D || c1 === 0x6D) && (c2 === 0x45 || c2 === 0x65) && (c3 === 0x54 || c3 === 0x74) && (c4 === 0x41 || c4 === 0x61) && (c5 === 0x09 || c5 === 0x0A || c5 === 0x0C || c5 === 0x0D || c5 === 0x20 || c5 === 0x2F)) {
        i += 6;
        let gotPragma = false;
        let needPragma = null;
        let charset = null;
