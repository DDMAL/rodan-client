...
(function(Buffer) {
  ...
  URLStateMachine.prototype["parse port"] = function parsePort(c, cStr) {
    if (isASCIIDigit(c)) {
      this.buffer += cStr;
    } else if (isNaN(c) || c === 47 || c === 63 || c === 35 || (specialSchemas[this.url.scheme] !== undefined && c === 92) || this.stateOverride) {
      if (this.buffer !== "") {
  ...
  URLStateMachine.prototype["parse path"] = function parsePath(c) {
    if (isNaN(c) || c === 47 || (specialSchemas[this.url.scheme] !== undefined && c === 92) || (!this.stateOverride && (c === 63 || c === 35))) {
      if (specialSchemas[this.url.scheme] !== undefined && c === 92) {
        this.parseError = true;
      }
